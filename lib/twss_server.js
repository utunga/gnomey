...
twss.threshold = config.twss.threshold; // something like 0.9997 is not even that high
...
function post_thats_what_she_said(message) {
    //NB: the yammer network, and identity used when posting is
    //    all controlled by what access_token is used
    //    see config.js to control that 
    yam.createMessage({
